...
Radnor-Winston neighborhood to the pertanent US census blocks. As can
...
\caption[Map of Radnor-Winston census blocks]{The Radnor Winston
  neighborhood shown with the pertanent census blocks. The boundaries
...
comprable to the state of Maryland overall.
